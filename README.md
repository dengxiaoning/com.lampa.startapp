...
- Use the reference https://blog.csdn.net/qq_34817440/article/details/100178255
...
> 
> Install: ```cordova plugin add https://github.com/dengxiaoning/com.lampa.startapp.git```
> 
...
**NEW!** [Script builder.](https://github.com/dengxiaoning/com.lampa.startapp/index.html) Create script with UI builder.
...
_Set application as intent value and flag ([issue](https://github.com/dengxiaoning/com.lampa.startapp/issues/50))_:
```js
var sApp = startApp.set({
